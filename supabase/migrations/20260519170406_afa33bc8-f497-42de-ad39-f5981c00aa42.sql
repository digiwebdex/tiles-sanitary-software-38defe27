-- Phase 6: configurable lead options (per dealer custom sources & statuses)
...
CREATE INDEX IF NOT EXISTS lead_options_dealer_kind_idx ON public.lead_options(dealer_id, kind);
